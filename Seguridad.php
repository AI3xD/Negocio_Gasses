...
$sql = "SELECT codigo, nombre, precio_venta, imagen_producto FROM productos WHERE categoria = 'seguridad'";
    ...
    <header>
      <div class="nav-catalogo">
        ...
        <nav class="catalogo-nav">
          ...
          <a href="gases.php">Ver más</a>
          <a href="gases.php">Gases</a>
          <a  href="soldadura.php">Soldaduras</a>
          <a class="active" href="Seguridad.php">Equipos de seguridad</a>
    ...
    <div class="imagen">
        <div class="overlay">
            <div class="contenido-imagen">
                <h2 class="texto-imagen" >Extractores de humo</h2>
                <p class="texto-imagen-parrafo">Reduce el riesgo ocacionado por el humo de soldadura.</p>
                <a href="#" class="boton-personalizado">Ver extractores de humo</a>
            </div>
        </div>
        <img  class="fondo-soldador" src="img/soldadorBanner.jpg" alt="Imagen soldador">

        <div class="contenedor-texto__catalogo">
            <h5 class="texto-titulos__catalogo">EQUIPO DE SEGURIDAD</h5>
            <br>
            <p class="texto-parrafo__catalogo">Equipo de seguridad personal adecuado para cada situación. Caretas, cascos, guantes, ropa y más. </p>
        </div>
    ...
    <div class="contenedor-grid">
        <div class="filtro-usuario">
            <div class="caja-filtro">
                ...
                <ul>
                    <li class="texto-filtro">
                        <a href="">Ropa de seguridad</a>
                    </li>
                </ul>

                <ul>
                    <li class="texto-filtro">
                        <a href="">Calzado de seguridad</a>
                    </li>
                </ul>
      ...
      <?php
            ...
            if ($result->num_rows > 0) {
              ...
              echo "No se encontraron productos de la categoría 'seguridad'.";
            }
            ?>
