...
$sql = "SELECT codigo, nombre, precio_venta, imagen_producto FROM productos WHERE categoria = 'soldadura'";
  ...
  <body>
    <header>
      <div class="nav-catalogo">
        ...
        <nav class="catalogo-nav">
          ...
          <a class="active" href="soldadura.php">Soldaduras</a>
    ...
    <div class="imagen">
        ...
        <div class="contenedor-texto__catalogo">
            <h5 class="texto-titulos__catalogo">CORTE Y SOLDADURA</h5>
            <br>
            <p class="texto-parrafo__catalogo">Accesorios y consumibles para soldar y cortar. Todo tipo de equipos de seguridad. </p>
        </div>
            ...
            <div class="caja-filtro">
                <ul>
                    <li class="texto-filtro">
                        <a href="">Consumibles de corte y soldadura
                        </a>
                    </li>
                </ul>
