    ...
    <div class="contenido-principal ">
      <div class="imagen">
        ...
        <div class="contenedor-texto__catalogo">
          ...
          <br>
          <p class="texto-parrafo__catalogo">Gases industriales, especiales y mezclas para todo tipo de aplicaciones
            requeridas. </p>
        </div>
            ...
            <div class="productos">
              <div class="contenedor__grid-cajas">
                ...
                if ($result->num_rows > 0) {
                  ...
                  echo "No se encontraron productos de la categoría 'gases'.";
                }
                ?>
